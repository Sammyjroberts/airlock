...
func main() {
	var inputFile, outputFile, interfaceName, packageName string
	...
	flag.StringVar(&packageName, "package", "", "Name of the go package to generate")
	flag.Parse()

	if inputFile == "" || outputFile == "" || interfaceName == "" || packageName == "" {
